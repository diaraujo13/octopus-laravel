...
<body>
	...
	<section class="hero-section set-bg" data-setbg="img/bg.jpg">
		<div class="container hero-text text-white">
			...
			<a href="#" class="site-btn">VEJA MAIS</a>
		</div>
	</section>
	<!-- Hero section end -->
	...
	<div class="filter-search">
		<div class="container">
			<form class="filter-form">
				...
				<select>
					<option value="City">Categoria</option>
				</select>
				<select>
					<option value="City">Cidade</option>
				</select>
				</select>
				<button class="site-btn fs-submit">PESQUISAR</button>
			</form>
		</div>
	</div>
	...
	<section class="properties-section spad">
		<div class="container">
			<div class="section-title text-center">
				...
				<p>Descubra os mais recentes anúncios cadastrados para venda</p>
			</div>
			<div class="row">
				<div class="col-md-6">
			...
			<div class="row">
				...
				<div class="col-lg-5 offset-lg-1 pl-lg-0">
					<div class="section-title text-white">
						...
						<p>Nós provemos os melhores serviços para </p>
					</div>
					<div class="services">
            ...
            @foreach($items as $item)
				<div class="col-lg-4 col-md-6">
					...
					<div class="feature-item">
						<div class="feature-pic set-bg" data-setbg="{{$item->photo}}">
							<div class="sale-notic">FOR SALE</div>
						</div>
						<div class="feature-text">
							...
							<a href="#" class="room-price">R$ {{$item->valor}}</a>
						</div>
					</div>
                </div>
            @endforeach
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <a href="mailto://visionalstudio@gmail.com" target="_blank">Visional Studio</a> | <a href="https://colorlib.com" target="_blank">Colorlib</a>
