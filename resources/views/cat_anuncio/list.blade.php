...
<div class="row wrapper white-bg page-heading">
    <div class="col-sm-4">
        <h2 class='p-20 layer w-100'>cat_anuncio</h2>
    </div>
    <div class="col-md-4 col-md-offset-4 offset-md-4">
        <div class="p-20 bgc-grey-100 layer w-100">
            <a href="{{route('cat_anuncio.create')}}" class="btn btn-primary btn-block">Novo cat_anuncio</a>
        </div>
    </div>
</div>
<div class="col-md-12">
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                {!! session('message.content') !!}
                    ...
                    @endif
                 <form action="{{route('cat_anuncio.index')}}" method='GET' role="search">
                    <div class="form-group row">
                        ...
                        <div class="col-md-2 col-sm-12">
                            ...
                            <div class="col-md-2 col-sm-12">
                                ...
                                <a href="{{route('cat_anuncio.index')}}" id='search_btn' class="btn btn-block btn-light">
                                    Limpar pesquisa </a>
                            </div>
                    </div>
                </form>
                ...
                <tr>
                   ...
                   <td class="actions-hover">
                    <a href={{route("cat_anuncio.edit", $item->id )}}><i class="fa fa-pencil"></i></a>
...
<div class="modal modal-danger fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{route('cat_anuncio.destroy', 'test')}}" method="POST">
                {{method_field('delete')}}
                {{csrf_field()}}
